...
export default async function OrderSuccessPage({
  ...
  return (
    <div className="container py-16 max-w-lg mx-auto">
      <Card className="text-center overflow-hidden border-emerald-500/20 shadow-lg">
        <div className="bg-emerald-500/10 p-8 flex flex-col items-center justify-center border-b border-emerald-500/10">
          <div className="h-16 w-16 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-md">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Reference No: <span className="font-mono font-bold text-foreground">{orderNumber}</span>
          </p>
        </div>

        <CardContent className="p-6 space-y-6">
          <p className="text-sm text-muted-foreground leading-relaxed">
            Your spare parts order has been logged into our dispatch database. Click the button below to open your complete order specification in WhatsApp.
          </p>
          ...
          {whatsappUrl ? (
            <a
              ...
              className="block"
            >
              <Button variant="whatsapp" size="lg" className="w-full gap-2 text-base h-12">
